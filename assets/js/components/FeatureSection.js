  ...
  render() {
    ...
    const features = feature.items.map((item) => `
      <li class="flex items-center gap-3 flex-row-reverse">
        <span class="w-8 h-8 rounded-full bg-accent/10 border border-accent/20 flex items-center justify-center shrink-0">
        ...
        <div class="max-w-[1280px] mx-auto px-4 md:px-6">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div class="relative order-1 lg:order-2">
              ...
              <div class="absolute bottom-6 left-6 right-6 md:left-8 md:right-auto md:max-w-[220px] bg-card/90 backdrop-blur-xl border border-border rounded-[24px] p-4 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
