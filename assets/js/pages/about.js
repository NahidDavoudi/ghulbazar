  ...
  return `
    ...
    <div class="max-w-[1280px] mx-auto px-4 md:px-6 py-10 md:py-14">
      <div class="${storeConfig.ui.cardBase} ${storeConfig.ui.cardRadius} p-6 md:p-10 mb-10">
        <h2 class="text-xl font-bold text-body mb-4 text-right">معرفی آیریس</h2>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div class="${storeConfig.ui.cardBase} ${storeConfig.ui.cardRadius} p-6 md:p-8">
          <div class="flex items-center gap-3 flex-row-reverse justify-end mb-4">
            <h2 class="text-lg font-bold text-body">مأموریت ما</h2>
        ...
        <div class="${storeConfig.ui.cardBase} ${storeConfig.ui.cardRadius} p-6 md:p-8">
          <div class="flex items-center gap-3 flex-row-reverse justify-end mb-4">
            <h2 class="text-lg font-bold text-body">چشم‌انداز ما</h2>
      ...
      <div class="mb-10">
        <h2 class="text-xl md:text-2xl font-bold text-body mb-6 text-right">چرا آیریس؟</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">${whyCards}</div>
      </div>
      <div class="mb-10">
        <h2 class="text-xl md:text-2xl font-bold text-body mb-6 text-right">آیریس در یک نگاه</h2>
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">${statCards}</div>
      </div>
      <div>
        <h2 class="text-xl md:text-2xl font-bold text-body mb-6 text-right">تیم ما</h2>
